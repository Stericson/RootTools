...
public final class RootToolsInternalMethods {
    ...
    /**
     * This will enclose a string in quotes if it contains any non-alphanumeric characters
     * other than periods or forward slashes. Will not quote a string that is already in quotes.
     * Used to escape filenames or other parameters used in shell commands.
     *
     * @param str    string to put in quotes
     * @return quoted string
     */
    private String quoteParam(String str) {
